...
class Logo extends React.Component {
	...
	render() {
        ...
        return (
            (this.props.fields.buttonpopup_text || this.props.fields.buttonpopup_material_icon) && <div class={"popupTrigger button rounded margin-top-1 ae-5 fromCenter " + this.props.fields.buttonpopup_stil+" "+this.props.fields.buttonpopup_farbe+" "+this.props.fields.buttonpopup_groesse} data-popup-id={this.props.popupid}>{left_text} <span class="material-icons"> {this.props.fields.buttonpopup_material_icon } </span>{right_text} </div>
        );
	}
}

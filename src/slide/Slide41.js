      ...
      <div class="wrap">
        ...
        <div class="fix-7-12 center">
          ...
          <div class="fix-4-12 margin-top-4">
            <Link to={this.props.slide.url[0]!==undefined ? this.props.slide.url[0].link: ""} nofollow={this.props.slide.follow} target={this.props.slide.target} class="author block">
